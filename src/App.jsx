...
const App = () => {
  ...
  console.log(filter, "filterrrrrrrrrrrrrrrrrrrrrrr");

  return (
    <>
      <Navbar
        setIsOpenBasket={setIsOpenBasket}
        setIsOpenBurger={setIsOpenBasket}
      />
      <Filter
      ...
      <Routes>
        <Route
          path="/"
          element={<Home setIsOpenFilter={setIsOpenFilter} filter={filter} />}
        />
        <Route
          path="/shop"
          element={<Shop setIsOpenFilter={setIsOpenFilter} />}
        />
